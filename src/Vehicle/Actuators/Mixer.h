...
public:
    ...
    Q_PROPERTY(bool advanced      READ advanced     CONSTANT)
    Q_PROPERTY(bool isTiltControl READ isTiltControl CONSTANT)
    Q_PROPERTY(bool isSecondaryTiltControl READ isSecondaryTiltControl CONSTANT)
    ...
    bool isTiltControl() const { return function() == Function::Tilt; }
    bool isSecondaryTiltControl() const { return function() == Function::SecondaryTilt; }
...
class ChannelConfigSecondaryTilt : public ChannelConfig
{
    Q_OBJECT
public:
    ChannelConfigSecondaryTilt(QObject* parent, const MixerParameter& parameter)
...
class ChannelConfigInstanceSecondaryTilt : public ChannelConfigInstance
{
    Q_OBJECT
public:
    ChannelConfigInstanceSecondaryTilt(QObject* parent, ChannelConfig& config, int tiltCount)
        : ChannelConfigInstance(parent, nullptr, config), _tiltCount(tiltCount) {}

    void allInstancesInitialized(QmlObjectListModel* configInstances) override;

private slots:
    void setFactFromPrimaryTilt();

private:
    ChannelConfigInstance* _primaryTilt{nullptr};
    const int _tiltCount{};
};
...
public:
    ...
    Q_INVOKABLE ChannelConfigInstance* secondaryTiltInstance() const;
