                            ...
                            ColumnLayout {
                                ...
                                GridLayout {
                                    ...
                                    Repeater {
                                        ...
                                        QGCLabel {
                                            text:           object.label
                                            visible:        object.visible && !object.isSecondaryTiltControl && (_showAdvanced || !object.advanced)
                                            Layout.row:     0
                                    ...
                                    Repeater {
                                        ...
                                        Repeater {
                                            ...
                                            Loader {
                                                id:             actuatorConfigLoader
                                                property var configInstance: object
                                                property var channelObject:  channel
                                                Layout.row:     1 + channelIndex
                                                Layout.column:  1 + index
                                                visible:        object.config.visible && !object.config.isSecondaryTiltControl && (_showAdvanced || !object.config.advanced) && object.visible
                                                enabled:        object.enabled

                                                Component {
                                                    id: singleActuatorFact

                                                    ActuatorFact {
                                                        fact: actuatorConfigLoader.configInstance.fact
                                                    }
                                                }

                                                Component {
                                                    id: tiltActuatorFacts

                                                    ColumnLayout {
                                                        spacing: ScreenTools.defaultFontPixelHeight * 0.25

                                                        readonly property var secondaryTilt: actuatorConfigLoader.channelObject.secondaryTiltInstance()
                                                        ...
                                                        RowLayout {
                                                            spacing: ScreenTools.defaultFontPixelWidth * 0.5
                                                            visible: secondaryTilt ? secondaryTilt.visible : true
                                                            enabled: secondaryTilt ? secondaryTilt.enabled : true
                                                            ...
                                                            ActuatorFact {
                                                                fact: secondaryTilt ? secondaryTilt.fact : null
                                                            }
                                                        }
                                                    }
                                                }

                                                sourceComponent: configInstance.config.isTiltControl ? tiltActuatorFacts : singleActuatorFact
                                            }
                                        }
                                    }
                                }
